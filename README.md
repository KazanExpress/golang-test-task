...
### Бонусные требования (опционально)
...
Загруженные картинки нужно сохранять как есть на S3. Например картинка с `id = m42bosu4x1xavjx` должна быть доступна по ссылке `https://bucket.my-storage.com/optional-prefix/m42bosu4x1xavjx/original.jpg`
